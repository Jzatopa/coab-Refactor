...
assert validation["stageable_entries"] == 9
...
with tempfile.TemporaryDirectory() as temp:
    ...
    assert report["integrated_entries"] == 9
    ...
    assert sum(row["stage_status"] == "integrated" for row in staged) == 9
...
print("integration foundation tests passed: 231 lookups, 9 staged, exact-ratio title set and rejected candidate preserved")
