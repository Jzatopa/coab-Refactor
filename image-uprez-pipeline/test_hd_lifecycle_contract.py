...
# The standard release launcher must prepare the same isolated, validated
# runtime as run-full-auto and take its default source data from this release's
# tracked Data/ tree. Launching Main.exe directly bypasses the runtime lookup
# and silently falls back to the original low-resolution art.
